            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl h-[80vh] flex flex-col">
                <div className="p-4 border-b border-gray-200 flex justify-between items-center">
                    <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                        <History size={24} /> Voucher History
                    </h2>
                        ...
                        <div className="grid gap-3">
                            {vouchers.map((voucher) => (
                                <div
                                    ...
                                    className="border border-gray-200 rounded-lg p-4 hover:bg-blue-50 cursor-pointer transition-colors flex justify-between items-center group"
                                >
                                    <div>
                                        <div className="font-bold text-gray-800">{voucher.pv_number}</div>
                                        <div className="text-sm text-gray-600">
                                            {voucher.date} • {voucher.pay_to}
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="text-right">
                                            <div className="font-bold text-gray-800">
                                                RM {voucher.total_amount?.toFixed(2)}
                                            </div>
